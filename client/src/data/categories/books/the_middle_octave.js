const the_middle_octave = {
  ...
  pages: [
    ...
    // chapter 1
    [
      { chapterHeader: 'פרק 1 - שלושה צלילים ראשונים' },
      { lessonHeader: 'מבוא' },

      {
        para: ' הצלילים שנלמד הם: דו, רה ו- מי באוקטבה האמצעית ואת ערכי הקצב שלמים וחצאים:',
      },
      {
        tune: {
          header: {
      ...
      {
        para: 'האקורדים שנלמד הם: דו מז׳ור וסול מז׳ור:',
      },
      {
        tune: {
          header: {
    ...
    [
      { lessonHeader: 'יצירה ראשונה' },
      {
        para: 'מטרת השיעור היא להצליח לנגן את היצירה שכתובה כאן.',
      },
      {
...
"C" CC | DC | "G" EC | "C" C2 |]`,
 ...
 "C" C2 E2 | C2 E2 |"G" D2 C2 |"C" C4 |]`,
    ...
    // chapter 2
    [
      { chapterHeader: 'פרק 2 - עוד שני צלילים' },
      { lessonHeader: 'מבוא' },
      {
...
"C" C C C D | C C C D |"G" E D D C |"C" C E C2 |]`,
  ...
  "C" E C D E |"F" D C C2 |"G" D C C2 |"C" C4 |]`,
    ...
    // chapter 5
    [
      { chapterHeader: 'פרק 5 - השלמת שבעת האקורדים' },
      { lessonHeader: 'מבוא' },
      {
