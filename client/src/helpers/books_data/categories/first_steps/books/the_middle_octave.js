    ...
    // chapter 1
    {
      ...
      lessons: [
        ...
        // lesson 3
        {
          ...
          lessonElements: [
            {
              para: 'בשיעור הקודם למדנו לעבוד עם יד ימין, והפעם נעבוד על יד שמאל.',
            },
            {
              para: 'בתרגילים הבאים אציג לכם תרשים עם האקורדים שלמדנו עד כה (דו מז׳ור וסול מז׳ור). את כל התרגילים אני רוצה שתנגנו קודם בטכניקת השורשים ולאחר מכן בטכניקת פירוקי הרבעים.',
            },
            {
            ...
            {
              para: 'אם לא כתוב אקורד חדש בתחילת תיבה, סימן זה אומר שהאקורד האחרון שנרשם הוא האקורד הנוכחי. במילים אחרות, ברגע שכתוב אקורד, זה האקורד של היצירה עד שנכתב אקורד חדש.',
            },
            {
              tune: {
                header: {
            ...
            {
              para: 'חשוב מאוד להתאמן על ליווי עם מטרונום ברקע. פיתוח תחושב קצב זה קריטי לנגנה בפסנתר ובכלל לכל מה שקשור למוזיקה.',
            },
            {
