      ...
      lessons: [
        // lesson 1
        {
          ...
          lessonElements: [
            ...
            {
              para: 'שימו לב שבמשקל של ארבע רבעים, הפסקה של שלם תופסת תיבה שלמה, כי הערך שלם הוא שווה ערך לבדיוק ארבע רבעים. הערך חצי שווה ערך לבדיוק שני רבעים, ולכן שני חצאים ממלאים תיבה שלמה במשקל של ארבע רבעים.',
            },
          ],
        },
        // lesson 2
        {
          ...
          lessonElements: [
            ...
            {
              para: 'בתור התחלה אני רוצה שרק תסתכלו על התרגיל, ותקראו בכל רם את התווים שכתובים בו. תוודאו שאתם מצליחים לזהות את כל התווים בתרגיל.',
            },
            {
              para: 'לאחר מכן תפעילו מטרונום על טמפו איטי ותמחאו כף לפי הקצב של המנגינה או אפילו יותר אם אתם יכולים, תנסו לשיר את התווים. תעשו ככה עד שהקצב והתווים ברורים לכם.',
            },
            {
              para: 'אז אחרי שהתווים מובנים והקצב ברור זה הזמן לנגן. תפעילו מטרונום ותנגנו את המנגינה לפי הקצב. נסו תוך כדי לספור את הפעימות(אחת, שתיים, שלוש, אבע...), לרקוע עם הרגל, להזיז את הגוף מעט לפי  הקצב, ולשיר את המנגינה ביחד עם הפסנתר. ככל שתרגישו את המוזיקה עם הגוף שלכם, האוזניים והמחשבה אתם תשתפרו בנגינה עצמה ובפיתוח החשיבה המוזיקלית.',
            },
