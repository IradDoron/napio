      ...
      lessons: [
        {
          ...
          lessonElements: [
            {
              para: 'מחשבה אחת ליוותה אותי בכתיבת הספר הזה - מהם הצעדים הראשונים שפסנתרן בתחילת דרכו צריך לעשות כדי לרכוש כלים יסודיים ומעשיים להתחלת לימוד הנגינה בפסנתר.',
            },
            {
              para: 'בגלל שלא מצאתי ספר כזה, החלטתי לכתוב אחד, ואם כבר אז למה לא להכין גרסה דיגיטלית  שאוכל לעדכן ולשפר אותו עם הזמן, ואם כבר גרסה דיגיטלית אז למה לא להכין אתר שלם שמתעסק בלימוד נגינה בפסנתר מכל הכיוונים.',
            },
            {
              para: 'הספר הזה מיועד למתחילים בלי אף ניסיון בנגינה, אך כדאי שיהיה מעט רקע בשמות הצלילים ובמושגים בסיסיים במוזיקה.',
            },
            {
              para: 'את טכניקות הליווי והנגינה אתם מוזמנים לבחור כרצונכם. אם אתם חדשים לגמרי בנגינה בפסנתר אני ממליץ להתחיל עם ליווי שורשים, ועם הזמן להתקדם לליווי פירוקי רבעים. תלמידים מתקדמים יותר יכולים ללוות בפירוקי שמיניות, בלוק-סטייל וכל טכניקה אחרת שאתם רוצים לתרגל.',
            },
            {
